...
func (self RefreshToken) NewGuard() RefreshToken {
	self.JWTRefreshTokenAPIKey = self.ConfigService.Get("JWT_REFRESH_TOKEN_KEY").(string)

	return self
}

func (self RefreshToken) CanActivate(c gooh.Context) bool {
