...
type READ_categories_OF_BY_id_Param_DTO struct {
	ID uint `bind:"id" validate:"required"`
}

func (instance READ_categories_OF_BY_id_Param_DTO) Transform(param gogo.Param, medata common.ArgumentMetadata) any {
...
type READ_categories_OF_BY_id_Query_DTO struct {
	CategoryID uint `bind:"category_id"`
}

func (instance READ_categories_OF_BY_id_Query_DTO) Transform(query gogo.Query, medata common.ArgumentMetadata) any {
