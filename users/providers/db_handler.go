...
type DBHandler struct {
	...
	AuthHandler   authProviders.DBHandler
}
...
func (self DBHandler) IsDuplicated(data []map[string]string) bool {
	for _, kv := range data {
		for k, v := range kv {
...
func (self DBHandler) FindOneBy(query *UserQuery) (*models.User, error) {
	userRec := &models.User{}
...
func (self DBHandler) FindManyBy(query *UserQuery) ([]*models.User, error) {
...
func (self DBHandler) CreateOne(data *UserCreation) (*models.User, error) {
